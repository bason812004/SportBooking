...
const menus = {
  ...
  ADMIN: [
    ...
    { to: "/admin/categories", label: "Danh mục sân", icon: Tags, group: "Vận hành" },
    ...
    { to: "/admin/reviews", label: "Đánh giá", icon: Star, group: "Nội dung" },
    ...
    { to: "/admin/settlements", label: "Quyết toán", icon: Landmark, group: "Tài chính" },
