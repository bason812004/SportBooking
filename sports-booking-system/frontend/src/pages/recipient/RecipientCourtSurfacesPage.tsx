...
function SurfaceTile({
    ...
    return (
        <button
            type="button"
            onClick={onSelect}
            className={`flex h-[260px] flex-col overflow-hidden rounded-xl border bg-white text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg ${selected ? "border-blue-500 ring-2 ring-blue-200" : "border-slate-200"
                }`}
        >
            ...
            <div className="flex min-h-0 flex-1 flex-col gap-2 p-3">
                ...
                <div className="mt-auto rounded-lg bg-slate-50 p-2 text-sm">
                    <p className="text-xs font-bold text-slate-500">{preview.label}</p>
                    <p className="mt-0.5 truncate font-semibold text-slate-800">{preview.text}</p>
                </div>
            </div>
        </button>
    );
                                ...
                                {selected.status === "OVERDUE" && selected.latestEndedBooking ? (
                                    <div className="space-y-3">
                                        ...
                                        <Button
                                            ...
                                            onClick={() => completeOverdue.mutate(selected.latestEndedBooking!.id)}
                                        >
                                    ...
                                    <div className="space-y-3">
                                        <div className="rounded-xl border border-blue-100 bg-blue-50/60 p-3">
                                            ...
                                            <p className="mt-1 text-sm text-slate-600">
                                                ...
                                                {selected.minutesLeft != null && selected.minutesLeft > 0 ? (
                                                    <span className="ml-1 font-semibold text-amber-700">(còn {selected.minutesLeft} phút)</span>
                                                ) : null}
                                            </p>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            {!selected.canExtend && (
                                                <p className="mt-2 text-sm font-semibold text-amber-700">Sân đã có lịch đặt ngay sau đó, không thể gia hạn.</p>
                                            )}
                                        </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Button
                                            ...
                                            onClick={() => earlyCheckIn.mutate(selected.nextBooking!.id)}
                                        >
