  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold">San cua toi</h1>
        <Link to="/partner/courts/create"><Button><Plus className="h-4 w-4" />Them san</Button></Link>
      </div>
      {courts.data?.length === 0 && <EmptyState title="Chua co san" />}
