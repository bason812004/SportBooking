...
import { BadgeCheck, Building2, CircleDollarSign, FileCheck2, KeyRound, Landmark, Mail, MapPin, Save, UserRound } from "lucide-react";
...
export function PartnerSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <Heading icon={<KeyRound />} title="Bảo mật" description="Đổi mật khẩu định kỳ để bảo vệ tài khoản" />
        ...
        <Button className="mt-6" disabled={changePassword.isPending}>{changePassword.isPending ? "Đang cập nhật..." : "Cập nhật mật khẩu"}</Button>
      </form>
    </div>
  );
}
