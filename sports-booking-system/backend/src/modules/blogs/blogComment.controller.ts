...
export const blogCommentController = {
  ...
  update: asyncHandler(async (req, res) => sendSuccess(res, await blogCommentService.update(req.params.slug, req.params.commentId, req.user!.id, req.user!.role, req.body.content))),
  delete: asyncHandler(async (req, res) => sendSuccess(res, await blogCommentService.delete(req.params.slug, req.params.commentId, req.user!.id, req.user!.role)))
};
