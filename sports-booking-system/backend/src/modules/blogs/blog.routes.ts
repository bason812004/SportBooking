...
blogRoutes.patch("/me/:id/comments", authMiddleware, blogController.updateMineComments);
...
blogRoutes.put("/:slug/comments/:commentId", authMiddleware, validate(blogCommentParamsSchema.merge(blogCommentSchema)), blogCommentController.update);
