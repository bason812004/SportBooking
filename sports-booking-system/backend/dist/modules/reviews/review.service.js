...
export const reviewService = {
    ...
    async create(userId, input) {
        ...
        if (booking.bookingStatus !== BookingStatus.COMPLETED)
            throw new ValidationError("Chi danh gia sau khi hoan thanh dat san");
        if (await reviewRepository.existingForBooking(input.bookingId))
            throw new ConflictError("Don dat san da duoc danh gia", "REVIEW_EXISTS");
